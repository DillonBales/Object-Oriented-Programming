...
patient4 = Covid19()
patient4.enter_pretest(0.5)
pretest = patient4.pretest
...
# Dillon Bales 6/13/2025

''' This program goes through and collects data about the patient and their condition, and what their respatory condition is, and what their covid symptoms are, and based on that data, it calculates the likleyhood they contracted covid
If i were to do my own version of the code I would make it so that it would analyze common cold symptoms and calculate if the patient has contracted it. sympotms like runny nose, sneezing, sore throat, cough, etc. '''